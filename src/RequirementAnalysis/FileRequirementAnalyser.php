...
class FileRequirementAnalyser extends RequirementAnalyser
{
    ...
    /**
     * FileRequirementAnalyser constructor
     *
     ...
     * @see \Pvra\RequirementAnalysis\RequirementAnalyser::__construct()
     */
